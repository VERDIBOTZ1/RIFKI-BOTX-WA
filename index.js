// Credit Gw Jan Di Hpus!!!
// Kalo mau ngrecode itu kasih credit gua!!
// scnya jan di jual Asuuu
// sc ini gw susun sendiri
// Sc By RIFKI BOTX( Gw Sendiri )
// Thx To Yogipw
// Hexagonz
// penyedia api & dan module 
// Lu hpus credit nya ga gw up esce lagi!
// Fix Bugg
// yg di enc jan di ubah ntar eror :/
const {
...
const time2 = moment().tz("Asia/Jakarta").format("HH:mm:ss");
    ...
    // ubah yg ada nomor gw:v , sama nama
banChats = true;
offline = false;
antidel = false;
antical = false
...
// Funcation stick cmd , Sorry enc:v
...
await itsmevall.updatePresence(from, Presence.composing)
    ...
    const ownerNumber = [`6285706735450@s.whatsapp.net`]
...
const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:bgg,sourceUrl:`https://wa.me/6285721599053?text=Assalamualaikum Sv Bang`}}})
		}
...
const freply7 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16505434800@s.whatsapp.net' } : {}) }, message: { "productMessage":{"product": {"productImage": {"mimetype":'image/jpeg',"jpegThumbnail": iye, "title": `${ucapanWaktu} ${pushname}`, "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
}
 const fkontak = { 
      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "Bang verdu", //Kasih namalu
            description: "VERDI 25",
            currencyCode: "USD",
...
const listmsg = (from, title, desc, list) => { // Fixx
            ...
            let po = itsmevall.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "Jangan Lupa Donasi Ya Kak","listType": "SINGLE_SELECT","sections": list}}, {})

            return itsmevall.relayWAMessage(po, {waitForAck: true})
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nRIFKI (RIFKI_WANDI_APRIYAN) â€¢Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`));
        let fil = vote.map((v) => v.participant);
        let id_vote = sender ? sender : "6285721599053@s.whatsapp.net";
        if (fil.includes(id_vote)) {
          return mentions(
            "@" + sender.split("@")[0] + " Anda sudah vote",
            fil,
...
await itsmevall.setStatus(`Aktif Selama: ${uptime} | Ucapan: ${ucapanWaktu} | Nama: ${pushname} | Mau Sewa? Hub Owner | User: RIFKI BOTX`).catch((_) => _);
...
case 'menu':
       txtt =`Hai Kak ${pushname}\nPilih Opsi Dibawah Ini Ya.. `
               ...
               buttons = [{buttonId:`${prefix}rifkibotx`, 
               buttonText:{displayText: 'LIST MENU'},type:1},
...
ã€…Special Thx  To ã€…
 ...
 - Senku
 - ItsMevall
 - All Creator Botâœ¨`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
ðŸ”–${prefix}unbanchat
ðŸ”–${prefix}listbc
ðŸ”–${prefix}antidelete on|off
ðŸ”–${prefix}autoketik on| off
ðŸ”–${prefix}autoread gc on / gc off
ðŸ”–${prefix}autovn on / off
ðŸ”–${prefix}antical on | off
ðŸ”–${prefix}getcaption
ðŸ”–${prefix}on
ðŸ”–${prefix}status
ðŸ”–${prefix}setthumb
ðŸ”–${prefix}settarget
ðŸ”–${prefix}setfakeimg
ðŸ”–${prefix}setreply
ðŸ”–${prefix}bugpc2
ðŸ”–${prefix}bugpc
ðŸ”–${prefix}bugcombine
ðŸ”–${prefix}buglokasi
ðŸ”–${prefix}bug [jumlah]
ðŸ”–${prefix}hacked
ðŸ”–${prefix}setprefix [2 Button]
ðŸ”–${prefix}mode [2 Button self/public]
ðŸ”–${prefix}term <code>
ðŸ”–${prefix}eval <code>
ðŸ”–${prefix}colongsw [reply sw]
    
*GRUPã€…*
ðŸ”–${prefix}grup [3 Button]
ðŸ”–${prefix}promote <reply chat member>
ðŸ”–${prefix}demote <reply chat member>
ðŸ”–${prefix}setdesc
ðŸ”–${prefix}setname
ðŸ”–${prefix}kick <reply/tag member>
ðŸ”–${prefix}add <reply/tag member>
ðŸ”–${prefix}getbio <reply chat member>
ðŸ”–${prefix}getname <reply chat member>
ðŸ”–${prefix}reminder <msg/2s>
ðŸ”–${prefix}listonline
ðŸ”–${prefix}sider [reply chat bot]
ðŸ”–${prefix}antilink
ðŸ”–${prefix}tod 
ðŸ”–${prefix}tospam jumlah
ðŸ”–${prefix}antihidetag
ðŸ”–${prefix}antiviewonce
ðŸ”–${prefix}autojoin
...
*MAKERã€…*
ðŸ”–${prefix}sticker
ðŸ”–${prefix}swm <author|packname>
ðŸ”–${prefix}take <author|packname>
ðŸ”–${prefix}fdeface
ðŸ”–${prefix}attp teks
ðŸ”–${prefix}fancytext teks
ðŸ”–${prefix}emoji
ðŸ”–${prefix}halloween teks
ðŸ”–${prefix}vampire teks
ðŸ”–${prefix}codetxt teks
ðŸ”–${prefix}matrix teks
ðŸ”–${prefix}googletxt teks
ðŸ”–${prefix}spiderman teks
ðŸ”–${prefix}express
ðŸ”–${prefix}teks teks
ðŸ”–${prefix}dance
ðŸ”–${prefix}nulis teks
ðŸ”–${prefix}text3d teks
ðŸ”–${prefix}warrior teks
...
ðŸ”–${prefix}asupan
ðŸ”–${prefix}viewonce
ðŸ”–${prefix}detikvn number
ðŸ”–${prefix}detikvideo number
ðŸ”–${prefix}hbd [ 2006 04 05 ]
...
ðŸ”–${prefix}join
ðŸ”–${prefix}dadu
ðŸ”–${prefix}bilangangka number
ðŸ”–${prefix}kalkulator
ðŸ”–${prefix}pantun
ðŸ”–${prefix}ss link web
ðŸ”–${prefix}liriklagu <query>
ðŸ”–${prefix}artinama <name>
ðŸ”–${prefix}debug
ðŸ”–${prefix}loli 
ðŸ”–${prefix}debug2
ðŸ”–${prefix}infogempa
ðŸ”–${prefix}resepmasakan
ðŸ”–${prefix}chat 62|P
ðŸ”–${prefix}caripesan <query>
ðŸ”–${prefix}get url
ðŸ”–${prefix}githubstalk <query>
ðŸ”–${prefix}ytsearch <query>
ðŸ”–${prefix}igstalk <query>
ðŸ”–${prefix}tiktokstalk <query>
ðŸ”–${prefix}play <query>
ðŸ”–${prefix}video <query>
ðŸ”–${prefix}igstory <username>
ðŸ”–${prefix}twitter <link>
ðŸ”–${prefix}tiktok <link>
ðŸ”–${prefix}tiktokaudio <link>
ðŸ”–${prefix}fb <link>
ðŸ”–${prefix}brainly <query>
ðŸ”–${prefix}image <query>
ðŸ”–${prefix}anime <random>
ðŸ”–${prefix}pinterest <query>
ðŸ”–${prefix}komiku <query>
ðŸ”–${prefix}lirik <query>
ðŸ”–${prefix}chara <query>
ðŸ”–${prefix}playstore <query>
ðŸ”–${prefix}otaku <query>
    
*JADI BOTã€…*
ðŸ”–${prefix}jadibot
ðŸ”–${prefix}stopjadibot
ðŸ”–${prefix}listbot
...
case 'menu2':
list = []
katalog('ASSALAMUALAIKUM BANG')
               listmenu = [`groupmenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`Fax`,`sewabot`,`Store Menu`]
               listmenuu = [`Menu Group`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Official Group`,`Rent this Bot`,`Store Menu`]
               nombor = 1
               startnum = 0
...
case 'sourcecode':
              reply('```List Source```')
              sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Mau List Source Yang Mana?`, [
              {
            buttonId: `${prefix}sourceyt`,
            buttonText: {
              displayText: `Source Yt`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}sourcegt`,
            buttonText: {
              displayText: `Source Gt`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}mastah`,
            buttonText: {
              displayText: `Mastah Botx`,
            },
            type: 1,
          },
        ]);
...
case 'storemenu':
              reply('```List Store```')
              sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Mau Top Up?`, [
              {
            buttonId: `${prefix}70dm`,
            buttonText: {
              displayText: `5 - 140 DM`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}140dm`,
            buttonText: {
              displayText: `140 - 355 DM`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}355dm`,
            buttonText: {
              displayText: `355 - 720 DM`,
            },
            type: 1,
          },
        ]);
        break
case 'listdm':
 reply('Bang Mau Top Up')
 sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Mau Top Up?`, [
                          {
            buttonId: `${prefix}pay1`,
            buttonText: {
              displayText: `LIST DM 5 - 140 DM\n5 DM = IDR 940\n20 DM = IDR 3.300\n50 DM = IDR 7.500\n70 DM = IDR 9.800\n100 DM = IDR 14.500\n140 DM = IDR 19.400`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}pay1`,
            buttonText: {
              displayText: `LIST DM 140 - 500 DM\n140 DM = IDR 19.400\n210DM = IDR 29.500\n280 DM = IDR 38.500\n355 DM = IDR 48.600\n425 DM = IDR 60.000\n500 DM = IDR 70.000`,
            },
            type: 1,
          },
          {
            buttonId: `${prefix}pay1`,
            buttonText: {
              displayText: `LIST DM 500 - 1000 DM\n500 DM = IDR 70.000\n570 DM = IDR 80.000\n640 DM = IDR 90.000\n720 DM = IDR 98.800\n860DM = IDR 118.500\n1000 DM = IDR 144.000`,
            },
            type: 1,
          },
        ]); 
        break
        case 'mygithub':
              katalog('Nyari Apa Bang?')
              sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Silahkan Pilih!`, [
              {
            buttonId: `${prefix}sc`,
            buttonText: {
        ...
        break
        case 'thanksto':
              katalog('*SPESIAL THANKS TO*\n\n*  Allah SWT*\n* Orang Tua Saya*\n* RIFKIBOTX*\n* verdi Ganz*\n*  Itsme Vall*\n*  YogiPw*\n*  Aldi Fauzi*\n*  Senku*\n*  Marcel Ganz*\n*  Hexagonz*\n*  Penyedia Module Dan Api*\n*  Taufik*')
        break
        case 'pay':
              reply('```Pilih Disini```')
              sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Silahkan Pilih!`, [
...
break
case 'sourceyt':
reply('*https://youtube.com/c/RIFKI01GAMINGLOVERS*')
break
case 'sourcegt':
reply('*https://github.com/VERDIBOTZ1*')
haibg =`Hai Kak ${pushname}\nItu Sourcenya, Mau Tanya Tanya?`
               buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: 'MY OWNER'},type:1},{buttonId:`${prefix}iggw`,buttonText:{displayText:'INSTAGRAM'},type:1}]
               buttonsMessage = { contentText: `${haibg}`, footerText: 'Kalo Mau Di Sv Chat Aja KakðŸ—¿ Jangan sungkan chat yahðŸ¥°', buttons: buttons, headerType: 1 }
...
reply('``` FORMAT ORDER\n NICK : \n ID/SERVER :\n JUMLAH TOP UP :\n SISA DM :\n PAYMENT :```')
            ...
            buttonId: `${prefix}store`,
            buttonText: {
              displayText: `STORE SIMPLE`,
            },
            type: 1,
           },
          {
            buttonId: `${prefix}listdm`,
            buttonText: {
              displayText: `STORE BUTTON`,
            },
            type: 1,
          },
        ]);
        break
case 'gk':
reply('```Wah Ngajak Gelut```')
              sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Silahkan Pilih!`, [
              {
            buttonId: `${prefix}gakmau`,
            buttonText: {
              displayText: `GAK MAU KAK`,
            },
            type: 1,
           },
          {
...
| -------------------------------------------
| *NOTE :*
| BOT AKTIF 07:00 - 21:00 WIB 
| -------------------------------------------

*MINAT?*
_CHAT : wa.me/${ownerNumber}_
...
"title": ` *10 DIAMOND = Rp 1.800*`,
 "rowId": ".menubayar"
 },{
"title": ` *20 DIAMOND = Rp 3.300*`,
 "rowId": ".menubayar"
 },{
"title": ` *50 DIAMOND = Rp 7.500*`,
 "rowId": ".menubayar"
 },{
"title": ` *70 DIAMOND = Rp 9.800*`,
 "rowId": ".menubayar"
 },{
"title": ` *100 DIAMOND = Rp 14.500*`,
 "rowId": ".menubayar"
 },{
"title": ` *120 DIAMOND = Rp 17.800*`,
 "rowId": ".menubayar"
 },{
"title": ` *140 DIAMOND = Rp 19.500*`,
 "rowId": ".menubayar"
 },{
"title": ` *210 DIAMOND = Rp 29.400*`,
 "rowId": ".menubayar"
 },{
"title": ` *280 DIAMOND = Rp 39.200*`,
 "rowId": ".menubayar"
 },{
"title": ` *355 DIAMOND = Rp 49.400*`,
 "rowId": ".menubayar"
 },{
"title": ` *425 DIAMOND = Rp 59.200*`,
 "rowId": ".menubayar"
 },{
"title": ` *500 DIAMOND = Rp 72.500*`,
 "rowId": ".menubayar"
 },{
"title": ` *720 DIAMOND = Rp 98.500*`,
 "rowId": ".menubayar"
 },{
"title": ` *1440 DIAMOND = Rp 197.000*`,
 "rowId": ".menubayar"
 },{
"title": ` *2000 DIAMOND = Rp 290.000*`,
 "rowId": ".menubayar"
 },{
"title": ` *2180 DIAMOND = Rp 315.000*`,
 "rowId": ".menubayar"
 },{
"title": ` *M.MINGGUAN = Rp 30.000*`,
 "rowId": ".menubayar"
 },{
"title": ` *M.BULANAN = Rp 115.000*`,
                                        "rowId": ".menubayar"
 },{
"title": ` *CHAT ADMIN*`,
"rowId": ".owner"
...
itsmevall.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [pushname]},quoted:ftrol})
              break
              case 'command':
               list = []
               listmenu = [`groupmenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`Fax`,`sewabot`,`Store Menu`]
...
break
        case 'gopay':
              reply('*No Gopay: 085706735450 A/N VERDI STORE*')
              break
        case 'dana':
              reply('*No Dana: 085706735450 A/N VERDI STORE*')
              break
case 'pay1':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_*\n\nBerikut adalah pembayaran yang tersedia di ${fakeyoi}`, "*_RIFKI BOTX_*", {jpegThumbnail:thumb}, [{buttonId:`${prefix}gopay`,buttonText:{displayText:'GOPAY'},type:1},{buttonId:`${prefix}dana`,buttonText:{displayText:'DANA'},type:1},{buttonId:`${prefix}ovo`,buttonText:{displayText:'OVO'},type:1}], {contextInfo: { mentionedJid: [fakeyoi,pushname]}})
              break
...
break
case 'iggw':
  reply('https://instagram.com/VERDI_STORE')
break
      /*case "owner":
        sendKontak(from, owner, "VERDI", "Sibuk");*/
case 'owner':
           case 'creator':
...
case 'mygithub2':
  reply('https://github.com/RIFKIBOTZ')
					break;
   case 'ss':
      reply(mess.wait)
...
case 'bugpc':
  ...
  if (!mek.key.fromMe) return;
itsmevall.updatePresence(from, Presence.composing)
itsmevall.sendMessage(from, 'yaudah oke',text, {
 quoted: {
  key: {
...
case "asupan": // by itsmevall
        sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Silahkan pilih Asupannya Kakâœ¨`, [
          {
            buttonId: `${prefix}+62`,
            buttonText: {
              displayText: `ðŸ”– Asupan +62`,
            },
            type: 1,
          },
          {
...
case "asupan2": // by itsmevall
        sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Silahkan pilih Asupannya V.2 kakâœ¨`, [
          {
...
case "asupan3": // by itsmevall
        sendButMessage(from, `Hai Kak ${pushname} ðŸ¤`, `Silahkan pilih Asupannya V.3 kakâœ¨`, [
          {
...
break
      ...
      case "colong":
        ...
        media = await itsmevall.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `RIFKI`;
        dua = typeof anu[1] !== "undefined" ? anu[1] : `BOTX`;
      ...
      case "self":
        ...
        break;
      case "hidetag":
        if (!mek.key.fromMe) return replyfakelink("KHUSUS BOT SAJA");
        haibg =`Hai Kak ${pushname}\nLagi Main Hidetag Ya, Btw Mau tau soal apa ya?`
               buttons = [{buttonId: `${prefix}mygithub`,buttonText:{displayText: 'SC BOT'},type:1},{buttonId:`${prefix}iggw`,buttonText:{displayText:'INSTAGRAM'},type:1}]
               buttonsMessage = { contentText: `${haibg}`, footerText: 'Kalo Mau Di Sv Chat Aja KakðŸ—¿ Jangan sungkan chat yahðŸ¥°', buttons: buttons, headerType: 1 }
               prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{})
               itsmevall.relayWAMessage(prep)
      ...
      case "s":
        if (
          ...
          args.length == 0
        	...
        	haibg =`Hai Kak ${pushname}\nNih Kak Sticker Nya, Mau tau soal apa ya?`
               buttons = [{buttonId: `${prefix}mygithub`,buttonText:{displayText: 'SC BOT'},type:1},{buttonId:`${prefix}iggw`,buttonText:{displayText:'INSTAGRAM'},type:1}]
               buttonsMessage = { contentText: `${haibg}`, footerText: 'Kalo Mau Di Sv Chat Aja KakðŸ—¿ Jangan sungkan chat yahðŸ¥°', buttons: buttons, headerType: 1 }
               prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{})
               itsmevall.relayWAMessage(prep)
      ...
      case "join":
        try {
          if (!isUrl(args[0]) && !args[0].includes("whatsapp.com"))
            return reply(mess.Iv);
          hen = args[0];
          if (!q) return replyfakelink("Masukan link group");
...
itsmevall.sendMessage(from, stdout, text, term)
      ...
      default:
        ...
        if (hour_now >= '18:00' && hour_now <= '19:00') {
        	console.log(color('[Pesan Bot]', 'cyan'), color('Alhamdulillah, Dah buka kak, Puasanya dibatalin dulu kak, Sebelum makan jangan lupa baca doa kak, Setelah makan langsung sholat Maghrib ya kak', 'yellow'), color('(ðŸ˜Š)', 'white'))
        }
        if (hour_now >= '19:00' && hour_now <= '20:00') {
           console.log(color('[Pesan Bot]', 'cyan'), color('Bentar lagi jam 8 kak, Yok kak main botnya buat nanti lagi, Sekarang siap-siap dulu buat Sholat Tarawih', 'yellow'), color('(ðŸ˜Š)', 'white'))
           }
        if (hour_now >= '20:00' && hour_now <= '00:00') {
          ...
          if (hour_now >= '00:00' && hour_now <= '02:00') {
           console.log(color('[Pesan Bot]', 'cyan'), color('ManikBot ngantuk kak, tidur dulu ya kak', 'yellow'), color('(ðŸ˜´)', 'white'))
        }
    ...
    e = String(e);// fixed fromMe by itsmevall
...
// Sekian Dari Gw Assamualaikum ðŸ™‚
